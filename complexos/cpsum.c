...
int main(int argc, char ** argv){
    ...
    if (argc < 4) { // Caso não sejam dados argumentos o suficiente,
        ...
        printf("Por favor, entre com o seguinte formato \"./cpsum <arquivo 1> <arquivo 2> <arquivo de saída>\".\n");
        return 0;
    }  
    ...
    resultante = Soma_complexo(complex1, complex2);
    free(complex1);
    free(complex2);

    if(resultante == NULL){
        printf("deu ruim na soma bixo!\n");
